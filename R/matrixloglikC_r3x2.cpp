...
// [[Rcpp::export]]
double matrixloglikC_r3x2(NumericMatrix data, NumericMatrix means, List covmat, NumericMatrix b, NumericMatrix c) {
    double L=0;
    double z[2];
    ...
    for (int i=0; i<4; i++){
        ...
        double p[6]={.000001,.000001,.000001,.000001,.000001,.000001};
        for(int a=0;a<100;a++){
		z[0]=z_vector[a];
		for(int f=0;f<100;f++){
			z[1]=z_vector[f];
